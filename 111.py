...
xml_files = []
for root, dirs, files in os.walk(r"F:\议会数据\议会数据\英国议会数据xml格式\commons_2009-2018"):
   xml_files.append(files)


for s in range(len(xml_files[0])):

    xml_files[0][s] =  "F:\\议会数据\\议会数据\\英国议会数据xml格式\\commons_2009-2018\\" + xml_files[0][s]
...
csvfile = open("C:\\Users\\Pluto\\Desktop\\2008_2018_commons.csv", "w", encoding='utf-8', newline='')
